...
public class DefaultBeanDefinitionDocumentReader implements BeanDefinitionDocumentReader {
	...
	/**
	 * doRegisterBeanDefinitions方法并没有自己去执行对xml节点的解析
	 * 而是委托给了BeanDefinitionParserDelegate，
	 * 通过代理去解析xml节点。
	 * Spring的xml文件又可能包含默认命名空间和自定义命名空间，我们来看Spring是如何进行处理的。
	 */
	 ...
	 * 其他的属于 custom 的，比如：<mvc />、<task />、<context />、<aop />等
	 */
